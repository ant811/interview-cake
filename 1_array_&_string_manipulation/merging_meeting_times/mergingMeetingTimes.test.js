...
test('Returns merged ranges of meeting times', () => {
  ...
  expect(mergeRanges([{ startTime: 1, endTime: 2 }, { startTime: 2, endTime: 3 }])).toEqual([{ startTime: 1, endTime: 3 }]);
  expect(mergeRanges([{ startTime: 1, endTime: 10 }, { startTime: 2, endTime: 6 }, { startTime: 3, endTime: 5 }, { startTime: 7, endTime: 9 },])).toEqual([{ startTime: 1, endTime: 10 }]);
});
